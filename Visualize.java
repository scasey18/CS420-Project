...
public class Visualize {
	...
	public Visualize(DefaultTreeModel model) {
		BufferedImage off_Image = new BufferedImage(findLargestX((DefaultMutableTreeNode) model.getRoot()) + 1,
				findLargestY((DefaultMutableTreeNode) model.getRoot()) + 1, BufferedImage.TYPE_INT_ARGB);
		...
		// view.setLocation(dim.width/2-view.getSize().width/2,
		// dim.height/2-view.getSize().height/2);
